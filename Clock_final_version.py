...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.pybutton.move(10,90)
        self.pybutton2.move(10, 10)
        ...
        self.pybutton.setStyleSheet("border: 2px solid rgb(4, 61, 30); background-color: rgb(6, 69, 34); color: rgb(245, 245, 245)")
        self.pybutton2.setStyleSheet("border: 2px solid rgb(4, 61, 30); background-color: rgb(6, 69, 34); color: rgb(245, 245, 245)")
